...
int main(void) {
    ...
    move_back(defaultLeftPower, defaultRightPower, 180); // correct by shifteing bot to the left
    turn_right(defaultLeftPower, defaultRightPower, 20);

    
    

    move_backUntil(defaultLeftPower+12, defaultRightPower, 3.75);
    ...
    //move_oneMotor(-1 * defaultRightPower, 'l', 350);

    move_back(defaultLeftPower, defaultRightPower, 800); // hit button
